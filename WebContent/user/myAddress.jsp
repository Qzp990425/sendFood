			...
			<div class="row pt-5 pb-5">
			  <div class="col-3">
			    <div class="list-group" id="list-tab" role="tablist">
			      ...
			      <a class="list-group-item list-group-item-action active" id="list-messages-list" href="${pageContext.request.contextPath}/address/getAddress" >我的地址</a>
			  ...
			  <div class="col-9">
			    <div class="tab-content" id="nav-tabContent">
			      <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
			      	<form action="${pageContext.request.contextPath}/address/addAddress">
			      		<p>新增地址</p>
			      		<input type="text" name="name"> 
			      		<input type="submit" value="新增" class="myBtn btn-primary">
			      	</form>
			      	 <table class="table">	
			      		<tr>
			      			<th>名称</th>
			      		...
			      		<c:forEach var="address" items="${addresses}">
			      			<tr>
			      				<td>${address.name}</td>
			      				<td>
			      					<a href="${pageContext.request.contextPath}/address/getAddressById?aid=${address.aid}" class="myBtn btn-primary">更改</a>
			      					<a href="${pageContext.request.contextPath}/address/deleteAddress?aid=${address.aid}" class="myBtn btn-primary">删除</a>
